...
{
	if (region.i.aw === region.g.aw)
	{
		return 'on line ' + region.i.aw;
	}
	return 'on lines ' + region.i.aw + ' through ' + region.g.aw;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { en: 'hidden', dx: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { en: 'mozHidden', dx: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { en: 'msHidden', dx: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { en: 'webkitHidden', dx: 'webkitvisibilitychange' }
		: { en: 'hidden', dx: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.d0.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done($elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done($elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.d0.b, xhr)); });
		$elm$core$Maybe$isJust(request.cD) && _Http_track(router, xhr, request.cD.a);

		try {
			xhr.open(request.eQ, request.gh, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.gh));
		}

		_Http_configureRequest(xhr, request);

		request.dn.a && xhr.setRequestHeader('Content-Type', request.dn.a);
		xhr.send(request.dn.b);
...
{
	var flags = 'g';
	if (options.eS) { flags += 'm'; }
	if (options.dw) { flags += 'i'; }
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {b_: fragment, b4: host, ci: path, ck: port_, cn: protocol, co: query};
	});
...
var $author$project$Types$EffFromRouter = function (a) {
	return {$: 1, a: a};
};
var $author$project$Types$Load = function (a) {
	return {$: 6, a: a};
};
var $author$project$Types$MsgForBlog = function (a) {
	return {$: 4, a: a};
};
var $author$project$Types$MsgForFaqNurses = function (a) {
	return {$: 5, a: a};
};
var $author$project$Types$MsgForHealthCare = function (a) {
	return {$: 3, a: a};
};
var $author$project$Types$MsgForJobs = function (a) {
	return {$: 2, a: a};
};
var $author$project$Device$NotSet = 3;
var $author$project$Router$Routes$Blog = function (a) {
	return {$: 5, a: a};
};
...
var $mdgriffith$elm_ui$Internal$Model$asEl = 2;
var $mdgriffith$elm_ui$Internal$Style$classes = {cQ: 'a', a7: 'atv', cS: 'ab', cT: 'cx', cU: 'cy', cV: 'acb', cW: 'accx', cX: 'accy', cY: 'acr', bL: 'al', bM: 'ar', cZ: 'at', a8: 'ah', a9: 'av', c2: 's', db: 'bh', dc: 'b', $7: 'w7', dq: 'bd', dr: 'bdt', aG: 'bn', ds: 'bs', aH: 'cpe', dz: 'cp', dA: 'cpx', dB: 'cpy', N: 'c', aM: 'ctr', aN: 'cb', aO: 'ccx', O: 'ccy', av: 'cl', aP: 'cr', dG: 'ct', dL: 'cptr', dM: 'ctxt', d9: 'fcs', bZ: 'focus-within', ea: 'fs', eg: 'g', bl: 'hbh', bn: 'hc', b1: 'he', bo: 'hf', b2: 'hfp', ep: 'hv', et: 'ic', ev: 'fr', aT: 'lbl', ex: 'iml', ey: 'imlf', ez: 'imlp', eA: 'implw', eB: 'it', eF: 'i', eL: 'lnk', an: 'nb', cd: 'notxt', eU: 'ol', eV: 'or', ac: 'oq', e0: 'oh', e1: 'pg', e3: 'p', e6: 'ppe', fj: 'ui', fl: 'r', fn: 'sb', fo: 'sbx', fp: 'sby', fq: 'sbt', fv: 'e', fw: 'cap', fy: 'sev', fG: 'sk', fV: 't', fW: 'tc', fX: 'w8', fY: 'w2', fZ: 'w9', f_: 'tj', a4: 'tja', f$: 'tl', f0: 'w3', f1: 'w5', f2: 'w4', f3: 'tr', f4: 'w6', f5: 'w1', f6: 'tun', cF: 'ts', ah: 'clr', ge: 'u', bH: 'wc', cL: 'we', bI: 'wf', cM: 'wfp', bJ: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.N);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eg);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e1);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e3);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fl);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fv);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.fm)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.J)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.fz.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.fz.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.fl) + ('-' + ($elm$core$String$fromInt(pos.bT) + ('-' + ($elm$core$String$fromInt(pos.cK) + ('-' + $elm$core$String$fromInt(pos.bm)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.ao.a) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.ao.b) + 'px'),
					$elm$core$Maybe$Just(
...
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
								...
								$mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
									{
										...
										ao: A2(
											...
											A2($elm$core$Tuple$mapFirst, $elm$core$Basics$toFloat, shadow.ao)),
										ap: shadow.ap
									}));
						},
						focus.fu),
			...
			A2(
			$mdgriffith$elm_ui$Internal$Model$Style,
			($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + ':focus .focusable, ') + (($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + '.focusable:focus, ') + ('.ui-slide-bar:focus + ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + ' .focusable-thumb'))),
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Style$baseSheet = _List_fromArray(
	[
		...
		A2(
		$mdgriffith$elm_ui$Internal$Style$Class,
		$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + ':focus',
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ep, $mdgriffith$elm_ui$Internal$Style$classes.ah)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ep, $mdgriffith$elm_ui$Internal$Style$classes.ac)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.d9, $mdgriffith$elm_ui$Internal$Style$classes.ah)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.d9, $mdgriffith$elm_ui$Internal$Style$classes.ac)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.a7, $mdgriffith$elm_ui$Internal$Style$classes.ah)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.a7, $mdgriffith$elm_ui$Internal$Style$classes.ac)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2 + ':first-child'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.c2 + ($mdgriffith$elm_ui$Internal$Style$selfName(3) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.c2))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.c2 + ($mdgriffith$elm_ui$Internal$Style$selfName(2) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.c2))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
...
var $mdgriffith$elm_ui$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + ($mdgriffith$elm_ui$Internal$Style$classes.c2 + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + ($mdgriffith$elm_ui$Internal$Style$classes.c2 + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fl) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fl) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aM) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aL: closing, s: _List_Nil, R: _List_Nil, H: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								s: A2(
									$elm$core$List$cons,
									{aL: '\n}', s: _List_Nil, R: props, H: '@supports (' + (prop + (':' + (value + (') {' + parent.H))))},
									rendered.s)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.H + ('{' + (renderValues(rule.R) + (rule.aL + '}')));
		}
	};
				...
				case 0:
					...
					return _List_fromArray(
						[
							...
							('.' + ($mdgriffith$elm_ui$Internal$Style$classes.c2 + (':focus ' + (selector + '-fs  {')))) + (renderedProps + '\n}'),
							(selector + '-fs:focus-within {') + (renderedProps + '\n}'),
							('.ui-slide-bar:focus + ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c2) + (' .focusable-thumb' + (selector + '-fs {')))) + (renderedProps + '\n}')
						]);
				default:
					return _List_fromArray(
						[
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var _class = '.' + cls;
				var any = '.' + $mdgriffith$elm_ui$Internal$Style$classes.c2;
				return $elm$core$List$concat(
					_List_fromArray(
						[
							A4(
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.fl) + (' / ' + ($elm$core$String$fromInt(position.fl + position.bm) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.bT) + (' / ' + ($elm$core$String$fromInt(position.bT + position.cK) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.fl) + ('-' + ($elm$core$String$fromInt(position.bT) + ('-' + ($elm$core$String$fromInt(position.cK) + ('-' + $elm$core$String$fromInt(position.bm)))))));
	...
	function (name, modifier, _v0) {
		...
		return _List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.fV + (', .' + (name + (' .' + (modifier + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.fV)))))))))), textAdjustment)
			]);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.fw + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.fV + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.fw + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.fV)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bm: height / size, ap: size, cI: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.dv, adjustment.da, adjustment.dQ, adjustment.eN]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fv))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.aM, $mdgriffith$elm_ui$Internal$Style$classes.O, $mdgriffith$elm_ui$Internal$Style$classes.cY])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.aM, $mdgriffith$elm_ui$Internal$Style$classes.O, $mdgriffith$elm_ui$Internal$Style$classes.cW])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.aM, $mdgriffith$elm_ui$Internal$Style$classes.cX])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.aM, $mdgriffith$elm_ui$Internal$Style$classes.cV])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.fV + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bn)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.fV + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bI + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bo)))));
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.eq, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.cQ]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.dc]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.eV]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.eU]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
							...
							default:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.db]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.eq, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.a8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bL);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.a8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bM);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.a8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cT);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.a9 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cZ);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.a9 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cS);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.a9 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cU);
	}
};
	...
	switch (h.$) {
		case 0:
			...
			return _Utils_Tuple3(
				...
				$mdgriffith$elm_ui$Internal$Style$classes.b1 + (' ' + name),
				_List_fromArray(
					[
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.c2 + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.N + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.c2 + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.fl + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 0:
									...
									var name = 'height-px-' + val;
									var $temp$classes = $mdgriffith$elm_ui$Internal$Style$classes.b1 + (' ' + (name + (' ' + classes))),
										$temp$node = node,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.O + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eL)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var $author$project$Styles$colors = {
	dg: A3($mdgriffith$elm_ui$Element$rgb255, 29, 30, 35),
	dh: A3($mdgriffith$elm_ui$Element$rgb255, 45, 45, 45),
	di: A3($mdgriffith$elm_ui$Element$rgb255, 51, 51, 50),
	bP: A3($mdgriffith$elm_ui$Element$rgb255, 181, 217, 255),
	dl: A3($mdgriffith$elm_ui$Element$rgb255, 24, 147, 189),
	dm: A3($mdgriffith$elm_ui$Element$rgb255, 29, 170, 217),
	dJ: A3($mdgriffith$elm_ui$Element$rgb255, 251, 247, 210),
	dK: A3($mdgriffith$elm_ui$Element$rgb255, 253, 252, 234),
	bg: A3($mdgriffith$elm_ui$Element$rgb255, 1, 55, 89),
	dO: A3($mdgriffith$elm_ui$Element$rgb255, 9, 68, 105),
	dP: A3($mdgriffith$elm_ui$Element$rgb255, 11, 87, 137),
	ec: A3($mdgriffith$elm_ui$Element$rgb255, 90, 90, 90),
	aR: A3($mdgriffith$elm_ui$Element$rgb255, 130, 130, 130),
	am: A3($mdgriffith$elm_ui$Element$rgb255, 204, 204, 204),
	ed: A3($mdgriffith$elm_ui$Element$rgb255, 71, 159, 108),
	ee: A3($mdgriffith$elm_ui$Element$rgb255, 88, 190, 129),
	ef: A3($mdgriffith$elm_ui$Element$rgb255, 99, 215, 145),
	fe: A3($mdgriffith$elm_ui$Element$rgb255, 106, 38, 41),
	ff: A3($mdgriffith$elm_ui$Element$rgb255, 146, 54, 55),
	fg: A3($mdgriffith$elm_ui$Element$rgb255, 195, 58, 66),
	fh: A3($mdgriffith$elm_ui$Element$rgb255, 200, 0, 0),
	gk: A3($mdgriffith$elm_ui$Element$rgb255, 223, 223, 223),
	as: A3($mdgriffith$elm_ui$Element$rgb255, 248, 248, 248),
	U: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)
};
...
var $mdgriffith$elm_ui$Element$Font$regular = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.f2);
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ge);
var $author$project$Styles$link = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$underline,
		$mdgriffith$elm_ui$Element$mouseOver(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$colors.bP)
			])),
		$mdgriffith$elm_ui$Element$Font$regular,
		$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$colors.dg)
	]);
...
var $author$project$View$joinCopy = {
	dS: 'We work with the very best.',
	e$: $elm$core$Maybe$Just(
		_List_fromArray(
			[
				...
				{
					_: $mdgriffith$elm_ui$Element$text('Read more about our values and culture.'),
					gh: $author$project$Router$Routes$toPath(
						$author$project$Router$Routes$Blog('culture'))
				}),
				$mdgriffith$elm_ui$Element$text(' '),
				$mdgriffith$elm_ui$Element$text('We interview and make hires within a week from our first meet–it\'s a commitment.')
			])),
	e2: 'Join the Team - Flint',
	e4: 'At Flint, we\'re committed to hiring the best people to build our teams. Building great products takes smart, disciplined, and empathetic individuals who can understand what job the products need to get done and imagine innovative ways to achieve it. Thus we designed the hiring process to help us identify those people.',
	e5: 'We foster a culture of respect, dialogue and growth where our team members can engage in a continuous conversation about product, engineering, and learning.',
	e7: 'We work with the very best.',
	bF: 'Join the Team',
	gl: 'Why do you want to work at Flint?'
};
var $author$project$Update$flintConfig = {c4: '/apply', dI: $author$project$View$joinCopy, dZ: '/j', e1: 'join'};
var $elm$browser$Browser$Dom$getViewport = _Browser_withWindow(_Browser_getViewport);
var $author$project$View$nurseCareersCopy = {dS: 'We work with the very best. Quality candidates lead to quality health outcomes.', e$: $elm$core$Maybe$Nothing, e2: 'Nurse Careers  - Flint', e4: 'At Flint, we\'re committed to finding the best people to staff health care teams. We work with highly internationally educated health care professionals who display care for their patients, have quality communication skills, good empathy skills, are attentive to details, can solve problems, and display autonomy and compliances with the standards can think critically and improve the American healthcare system.', e5: 'We work with internationally educated health care workers from around the world for staffing opportunities in the United States of America. We offer an all-inclusive solution for the workers to have a seamless transition into their new life in America. We pay for certain legal and processing fees, licensing and offer premium placement.', e7: 'We work with the very best.', bF: 'Launch your nursing career in America', gl: 'Why do you want to work in the United States of America?'};
var $author$project$Update$healthCareConfig = {c4: '/happly', dI: $author$project$View$nurseCareersCopy, dZ: '/hc', e1: 'nurse-careers'};
var $author$project$Blog$Types$Loading = {$: 0};
var $author$project$Blog$Types$ReceiveBlogData = function (a) {
	return {$: 0, a: a};
};
var $author$project$Blog$Update$blogDefaultPageTitle = 'Blog - Flint';
			...
			return $elm$http$Http$Request(
				{
					c_: r.c_,
					dn: r.dn,
					d0: A2(_Http_mapExpect, func, r.d0),
					b0: r.b0,
					eQ: r.eQ,
					f9: r.f9,
					cD: r.cD,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{c_: false, dn: r.dn, d0: r.d0, b0: r.b0, eQ: r.eQ, f9: r.f9, cD: r.cD, gh: r.gh}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{dn: $elm$http$Http$emptyBody, d0: r.d0, b0: _List_Nil, eQ: 'GET', f9: $elm$core$Maybe$Nothing, cD: $elm$core$Maybe$Nothing, gh: r.gh});
};
...
var $author$project$Blog$Update$init = function (article) {
	return A2(
		$Fresheyeball$elm_return$Return$return,
		{c6: $author$project$Blog$Types$Loading, c7: _List_Nil, bF: $author$project$Blog$Update$blogDefaultPageTitle, gc: '', gj: article},
		$elm$http$Http$get(
			{
				d0: $elm$http$Http$expectString($author$project$Blog$Types$ReceiveBlogData),
				gh: '/articles'
			}));
};
var $author$project$Contact$Update$init = {bF: 'Contact - Flint', gc: ''};
var $author$project$FaqNurses$Types$Faq = F4(
	function (id, question, answer, isVisible) {
		return {c1: answer, er: id, eE: isVisible, fa: question};
	});
var $author$project$FaqNurses$Types$ListItem = function (a) {
	return {$: 1, a: a};
};
var $author$project$FaqNurses$Types$Paragraph = function (a) {
	return {$: 0, a: a};
};
var $author$project$FaqNurses$Update$faqs = function (faqs_) {
	return A2(
		$elm$core$List$indexedMap,
		F2(
			function (id, faq) {
				return A4($author$project$FaqNurses$Types$Faq, id, faq.fa, faq.c1, faq.eE);
			}),
		faqs_);
}(
	_List_fromArray(
		[
			...
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('International educated Registered Nurses (RN) with a willingness to relocate to the US permanently to work as a RN.')
				]),
			eE: true,
			fa: 'Who is this for?'
		},
			...
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('We work with US employers such as hospitals to source great nurses internationally. We work with these international nurses getting them licensed, arranging a new job and immigration to ultimately begin their new life in the US.')
				]),
			eE: false,
			fa: 'How does it work?'
		},
			...
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('To get started you can visit withflint.com and click the apply button.')
				]),
			eE: false,
			fa: 'How do I apply?'
		},
			...
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('To apply you need:'),
					$author$project$FaqNurses$Types$ListItem('A valid nursing license in any country'),
					$author$project$FaqNurses$Types$ListItem('Nursing education from a program approved by the U.S. State Nursing Board'),
					$author$project$FaqNurses$Types$ListItem('At least 1 year of Registered Nursing experience in a hospital setting'),
					$author$project$FaqNurses$Types$ListItem('Good english and communication skills')
				]),
			eE: false,
			fa: 'What do I need to apply?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('Yes, the agreement is a two way commitment. It legally binds us to follow through with our financial obligations and to follow through with the process. The agreement also ensures that you will follow through with the process as we will be investing significant financial resources into you.')
				]),
			eE: false,
			fa: 'Do I have to sign a contract with Flint?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('We provide you the opportunity to connect with our other customers who have gone before you and are working in the US today as RNs. Before starting we will sign agreements with you which legally binds us to our obligations. We are a registered US company and are subject to all the immigration and labor laws.')
				]),
			eE: false,
			fa: 'How do I know I can trust Flint?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('We pay for virtually everything except small initial expenses. We need to ensure that the candidate will take this seriously and follow through. For example, we may ask you to cover the fees associated with registering for the NCLEX qualifying exam.')
				]),
			eE: false,
			fa: 'What will Flint pay for and what do I need to pay for?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('The US employer funds the whole process and we take a portion of that for our services.')
				]),
			eE: false,
			fa: 'How does Flint make money?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('Yes there are opportunities for you to bring spouses and dependents with you to begin your new life in the US. The opportunity varies depending on the immigration path you take. If you want to immigrate with your family make sure to include that in your profile when you are prompted.')
				]),
			eE: false,
			fa: 'Can I bring my family with me?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('We do provide temporary accommodations such as a hotel or Airbnb for the first two weeks in the US or until your first paycheck. We help you find long term rental living accommodations just like many other Americans who cannot afford to buy a house.')
				]),
			eE: false,
			fa: 'What will my living arrangements be in the US.'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('You will be paid every two weeks from your employer unless otherwise stated in your contract.')
				]),
			eE: false,
			fa: 'How will I be paid?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('It is recommended to save money in order to cover some expenses before you receive your first paycheck. We do cover basic expenses for you such as temporary accommodations and food in your first two weeks in the US or until your first paycheck.')
				]),
			eE: false,
			fa: 'Should I save money in advance?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('We will provide you guidance through the whole process sharing next steps along the whole journey. This includes licensing, immigration, and employment arrangements. We connect you with other nurses who are at a similar part of the journey in your cohort to support and encourage each other. We also provide you the opportunity to connect with other nurses who have gone before you.')
				]),
			eE: false,
			fa: 'How much support will I get throughout the process?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('Currently looking for RNs with bedside experience for hospital positions.')
				]),
			eE: false,
			fa: 'What type of Registered Nurses (RNs) are you looking for?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('Currently we only employ RNs.')
				]),
			eE: false,
			fa: 'Do you employ positions other than Registered Nurses (RNs)?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('The more qualified you are the better. We prefer more experience, better communication, and more nursing education. If you already have a US nursing license or some of the documents required for US licensing that is also a benefit. In addition nursing experience in the following areas are more desirable: Intensive Care, Critical Care, Medical-surgical, Emergency.')
				]),
			eE: false,
			fa: 'What will help my chances of being selected?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('The process length varies case to case and depends on many factors such as the visa and country of origin. In most cases you must be licensed before we can start the immigration process. The faster you can be licensed the quicker you can start working in the US. While we cannot guarantee immigration processing times, for a typical employment based immigration path we expect up to 2 years for the full licensing and immigration to start work in the US.')
				]),
			eE: false,
			fa: 'How long is the process?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('We work with many different types of hospitals and health centers all over the US that are looking for nurses. You will go through a matching and interview process with prospective employers before we start immigration so you know where you will be going. We consider your skills, experience, and goals when assessing which hospital is best suited to you. We consider both your preferences and the needs of the hospital to ensure that we make a match that works well for nurses and the facilities.')
				]),
			eE: false,
			fa: 'Where in the US will I work?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('A typical employment contract will be 3 years. The goal is for us to match you with the right employer for a good long term fit as this is what the employers want as well. We consider your skills, experience, and goals when assessing which hospital is best suited to you. We consider both your preferences and the needs of the hospital to ensure that we make a match that works well for nurses and the facilities. You will have opportunities to review the contract before committing.')
				]),
			eE: false,
			fa: 'How long is the employment contract and what happens when it\'s complete?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('This depends on your situation. The most popular visa process is the EB3 visa which is an employment based permanent resident visa. If you are Canadian or Mexican other options include a TN visa which is a temporary work visa. By filling out your profile we help identify alternative immigration paths that may work better for your specific situation.')
				]),
			eE: false,
			fa: 'What type of US visa would I be using?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('In order to become licensed to work in the US as a RN, nurses must take and pass a qualifying exam called the NCLEX. In most cases you must pass the NCLEX qualifying exam before we can start the immigration process. If you\'ve already passed it you won\'t need to take it again.')
				]),
			eE: false,
			fa: 'What is the NCLEX exam?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('We provide study materials and resources to help you prepare. We also connect you with other nurses who are also preparing for the test to support each other.')
				]),
			eE: false,
			fa: 'How should I prepare for the NCLEX?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('Failed tests will prolong the process so it\'s important to do your best to pass the first time. You may take the test again in 45 days at the earliest. This is a rule set by the testing authority.')
				]),
			eE: false,
			fa: 'What happens if I fail the NCLEX in my first attempt?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('We can but it depends on the situation. If you have specific questions you can reach out to our team to find out more.')
				]),
			eE: false,
			fa: 'If I\'m already in the immigration and licensing process can I work with Flint?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('Employers care that you can communicate effectively with staff and patients. They require you to be fluent in English, which can be demonstrated in the interviews and in the English test.')
				]),
			eE: false,
			fa: 'What is the level of English proficiency that is required?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('Yes, for immigration and licensing you will need to take one of either the IELTS or TOEFL english tests unless your nursing education was in the following countries and your textbooks were in English (United Kingdom, Australia, Canada (except Quebec), New Zealand, Ireland or the United States). If you have already taken an English test recently, we can use those scores.')
				]),
			eE: false,
			fa: 'Will I need to take an English test?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('For the IELTS (Academic Format) the overall score must be at least 6.5 and the spoken band 7.0. For the TOEFL iBT you must have an overall score greater than 83 and 26 in the speaking section.')
				]),
			eE: false,
			fa: 'What is a passing score for the English test?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('Yes you and every family member coming with you will need a passport.')
				]),
			eE: false,
			fa: 'Will I need a passport?'
		},
			{
			c1: _List_fromArray(
				[
					$author$project$FaqNurses$Types$Paragraph('The US has lots of programs to help you achieve your career goals. Be sure to let your prospective employer know what your goals are.')
				]),
			eE: false,
			fa: 'Will I be able to study and continue to specialize in certain nursing areas after I come?'
		}
		]));
...
var $author$project$FaqNurses$Update$init = $Fresheyeball$elm_return$Return$singleton(
	{d4: $author$project$FaqNurses$Update$faqs, em: 'FAQ for Internationally Educated Nurses', bF: 'FAQ for Internationally Educated Nurses - Flint'});
var $author$project$Home$Update$init = {bF: 'Flint - Securing Nurses for Your Future', gc: ''};
var $author$project$Jobs$Types$ApplyView = function (a) {
	return {$: 0, a: a};
};
var $author$project$Jobs$Types$JobsView = {$: 1};
var $author$project$Jobs$Types$ReceiveJobsData = function (a) {
	return {$: 2, a: a};
};
var $author$project$Text$Empty = {$: 2};
var $author$project$Jobs$Update$emptyApplicant = {dX: $author$project$Text$Empty, d8: $author$project$Text$Empty, eJ: $author$project$Text$Empty, bv: $author$project$Text$Empty, fc: $author$project$Text$Empty, fi: $elm$core$Maybe$Nothing};
var $elm$url$Url$Parser$Parser = $elm$core$Basics$identity;
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {Y: frag, ad: params, T: unvisited, bG: value, ai: visited};
	});
...
var $author$project$Jobs$Update$idParser = function (config) {
	return A2(
		$elm$url$Url$Parser$slash,
		$elm$url$Url$Parser$s(config.e1),
...
var $author$project$Jobs$Update$init = F4(
	function (gitVersion, url, key, config) {
		return A2(
			$Fresheyeball$elm_return$Return$return,
			{
				c3: $author$project$Jobs$Update$emptyApplicant,
				dE: config,
				...
				gi: function () {
					var _v0 = A2(
						...
						A2(
							...
							$author$project$Jobs$Update$idParser(config),
							url));
					if (_v0 === '') {
						return $author$project$Jobs$Types$JobsView;
					} else {
						var jobId = _v0;
						return $author$project$Jobs$Types$ApplyView(jobId);
					}
				}()
			},
			$elm$http$Http$get(
				{
					d0: $elm$http$Http$expectString($author$project$Jobs$Types$ReceiveJobsData),
					gh: config.dZ
				}));
	});
var $author$project$Router$Routes$NotFound = {$: 1};
var $author$project$Router$Routes$Contact = {$: 2};
var $author$project$Router$Routes$FaqNurses = {$: 6};
var $author$project$Router$Routes$Home = {$: 0};
var $author$project$Router$Routes$JoinTheTeam = function (a) {
	return {$: 3, a: a};
};
var $author$project$Router$Routes$NurseCareers = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$Router$Routes$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Router$Routes$JoinTheTeam(''),
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Router$Routes$NurseCareers(''),
			$elm$url$Url$Parser$s('nurse-careers')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Router$Routes$NurseCareers,
			A2(
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Router$Routes$Blog(''),
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Router$Routes$FaqNurses,
			$elm$url$Url$Parser$s('internationally-educated-nurses-faq'))
		]));
...
var $uncover_co$elm_submodules$SubModule$init = F2(
	function (config, _v0) {
		var subModel = _v0.a;
		var subCmd = _v0.b;
		return _Utils_Tuple2(
				...
				function (cmd_) {
					return $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								cmd_,
								A2($elm$core$Platform$Cmd$map, config.w, subCmd)
							]));
				}));
	});
				...
				function (cmd_) {
					return $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								cmd_,
								A3($uncover_co$elm_submodules$SubModule$subCmdToMsg, config.w, config.bV, subCmd)
							]));
				}));
	});
var $author$project$Update$init = F3(
	function (_v0, url, key) {
		var article = _v0.c6;
		var gitVersion = _v0.eb;
		var _v1 = A2(
			$uncover_co$elm_submodules$SubModule$initWithEffect,
			{bV: $author$project$Types$EffFromRouter, w: $author$project$Types$MsgForRouter},
			A2($author$project$Router$Update$init, url, key));
		var router = _v1.a;
		var initRouter = _v1.b;
		var _v2 = A2(
			$uncover_co$elm_submodules$SubModule$init,
			{w: $author$project$Types$MsgForJobs},
			A4($author$project$Jobs$Update$init, gitVersion, url, key, $author$project$Update$flintConfig));
		var jobs = _v2.a;
		var initJobs = _v2.b;
		var _v3 = A2(
			$uncover_co$elm_submodules$SubModule$init,
			{w: $author$project$Types$MsgForHealthCare},
			A4($author$project$Jobs$Update$init, gitVersion, url, key, $author$project$Update$healthCareConfig));
		var healthCare = _v3.a;
		var initHealthCare = _v3.b;
		var _v4 = A2(
			$uncover_co$elm_submodules$SubModule$init,
			{w: $author$project$Types$MsgForBlog},
			$author$project$Blog$Update$init(article));
		var blog = _v4.a;
		var initBlog = _v4.b;
		var _v5 = A2(
			$uncover_co$elm_submodules$SubModule$init,
			{w: $author$project$Types$MsgForFaqNurses},
			$author$project$FaqNurses$Update$init);
		var faqNurses = _v5.a;
		return initBlog(
			initHealthCare(
				initJobs(
					initRouter(
						A2(
							$Fresheyeball$elm_return$Return$return,
							{dk: blog, dF: $author$project$Contact$Update$init, dU: 3, d3: faqNurses, el: healthCare, eo: $author$project$Home$Update$init, eG: jobs, fk: router, bF: 'Flint - Securing Nurses for Your Future', gh: url},
							A2($elm$core$Task$perform, $author$project$Types$Load, $elm$browser$Browser$Dom$getViewport))))));
	});
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onResize($author$project$Types$Resize);
};
var $author$project$Blog$Types$LoadArticle = function (a) {
	return {$: 1, a: a};
};
var $author$project$Jobs$Types$SwitchView = function (a) {
	return {$: 5, a: a};
};
var $author$project$Device$Desktop = 2;
var $author$project$Device$Phone = 0;
var $author$project$Device$Tablet = 1;
var $author$project$Device$classify = function (window) {
	return (window.cK < 700) ? 0 : ((window.cK <= 1200) ? 1 : 2);
};
...
var $author$project$Router$Routes$parse = $elm$url$Url$Parser$parse($author$project$Router$Routes$routes);
var $author$project$Blog$Types$List = function (a) {
	return {$: 1, a: a};
};
var $author$project$Blog$Types$NotFound = {$: 3};
var $author$project$Blog$Types$Loaded = function (a) {
	return {$: 2, a: a};
};
var $author$project$Blog$Update$chooseArticle = F2(
	function (articles, viewing) {
		return A3(
			$elm$core$List$foldr,
			F2(
				function (article_, selected) {
					if (selected.$ === 2) {
						return selected;
					} else {
						return _Utils_eq(article_.fx, viewing) ? $author$project$Blog$Types$Loaded(article_) : $author$project$Blog$Types$NotFound;
					}
				}),
			$author$project$Blog$Types$NotFound,
			articles);
	});
var $author$project$Blog$Types$Article = function (author) {
	return function (bio) {
							...
							return function (sub) {
								return function (body) {
									return function (meta) {
										return {bN: author, c8: avatar, df: bio, dn: body, dN: date, eL: link, eP: meta, fx: slug, fK: sub, bF: title};
									};
								};
							};
						};
...
var $author$project$Blog$Types$Meta = F7(
	function (type_, title, url, image, description, author, publishedTime) {
		return {bN: author, dR: description, es: image, e9: publishedTime, bF: title, gd: type_, gh: url};
	});
var $author$project$Blog$Update$decodeMeta = A2(
	$elm_community$json_extra$Json$Decode$Extra$andMap,
	A2($elm$json$Json$Decode$field, 'publishedTime', $elm$json$Json$Decode$string),
	A2(
		$elm_community$json_extra$Json$Decode$Extra$andMap,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							$elm$json$Json$Decode$succeed($author$project$Blog$Types$Meta))))))));
var $author$project$Blog$Update$decode = A2(
	$elm_community$json_extra$Json$Decode$Extra$andMap,
	A2($elm$json$Json$Decode$field, 'meta', $author$project$Blog$Update$decodeMeta),
	A2(
		$elm_community$json_extra$Json$Decode$Extra$andMap,
							...
							A2(
								...
								A2(
									...
									A2(
										$elm_community$json_extra$Json$Decode$Extra$andMap,
										A2($elm$json$Json$Decode$field, 'author', $elm$json$Json$Decode$string),
										$elm$json$Json$Decode$succeed($author$project$Blog$Types$Article)))))))))));
var $elm$json$Json$Decode$decodeString = _Json_runOnString;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Blog$Update$updatePageTitle = function (model) {
	var _v0 = model.gj;
	if (_v0.$ === 1) {
		return _Utils_update(
			model,
			{bF: $author$project$Blog$Update$blogDefaultPageTitle});
	} else {
		var _v1 = model.c6;
		if (_v1.$ === 2) {
			var article = _v1.a;
...
var $author$project$Blog$Update$update = F2(
	function (msg, model) {
		return A2(
			$Fresheyeball$elm_return$Return$map,
			$author$project$Blog$Update$updatePageTitle,
			function () {
				switch (msg.$) {
					case 0:
						var result = msg.a;
						if (!result.$) {
							...
							var _v2 = A2(
								...
								$elm$json$Json$Decode$list($author$project$Blog$Update$decode),
								raw);
							if (!_v2.$) {
								var articles = _v2.a;
								var _v3 = model.gj;
								if (_v3.$ === 1) {
									return $Fresheyeball$elm_return$Return$singleton(
										_Utils_update(
											model,
											{
												c6: $author$project$Blog$Types$List(articles),
												c7: articles
											}));
								} else {
									var article = _v3.a;
									return $Fresheyeball$elm_return$Return$singleton(
										_Utils_update(
											model,
											{
												c6: A2($author$project$Blog$Update$chooseArticle, articles, article),
												c7: articles
											}));
								}
							} else {
								return $Fresheyeball$elm_return$Return$singleton(
									_Utils_update(
										model,
										{c6: $author$project$Blog$Types$NotFound}));
							}
						} else {
							return $Fresheyeball$elm_return$Return$singleton(
								_Utils_update(
					...
					case 2:
						return $Fresheyeball$elm_return$Return$singleton(
							_Utils_update(
								model,
								{
									c6: $author$project$Blog$Types$List(model.c7)
								}));
					default:
						var article = msg.a;
						if (article === '') {
							...
							return $Fresheyeball$elm_return$Return$singleton(
								_Utils_update(
									model,
									{
										c6: A2($author$project$Blog$Update$chooseArticle, model.c7, article)
									}));
						}
				}
			}());
	});
var $author$project$FaqNurses$Update$update = F2(
	function (msg, model) {
		var id = msg;
		var toggle = function (faq) {
			return _Utils_eq(faq.er, id) ? _Utils_update(
				faq,
				{eE: !faq.eE}) : faq;
		};
		return $Fresheyeball$elm_return$Return$singleton(
			_Utils_update(
				model,
				{
					d4: A2($elm$core$List$map, toggle, model.d4)
				}));
	});
var $author$project$Jobs$Types$Resume = function (a) {
	return {$: 1, a: a};
};
var $author$project$Jobs$Types$SendApplicantData = function (a) {
	return {$: 3, a: a};
};
var $author$project$Text$Valid = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Text$isValid = function (text) {
	if (text.$ === 1) {
		return true;
	} else {
		return false;
...
var $author$project$Jobs$Types$Job = F6(
	function (url, title, location, equity, experience, description) {
		return {dR: description, d_: equity, d1: experience, eM: location, bF: title, gh: url};
	});
var $elm$json$Json$Decode$map6 = _Json_map6;
var $author$project$Jobs$Update$jobDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Jobs$Types$Job,
	A2($elm$json$Json$Decode$field, 'url', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'location', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'equity', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'experience', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'description', $elm$json$Json$Decode$string));
var $author$project$Jobs$Update$jobsDecoder = $elm$json$Json$Decode$dict($author$project$Jobs$Update$jobDecoder);
var $author$project$Jobs$Update$modifyApplicant = F2(
	function (model, f) {
		return _Utils_update(
			model,
			{
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{dn: r.dn, d0: r.d0, b0: _List_Nil, eQ: 'POST', f9: $elm$core$Maybe$Nothing, cD: $elm$core$Maybe$Nothing, gh: r.gh});
};
var $elm$browser$Browser$Navigation$pushUrl = _Browser_pushUrl;
var $elm$http$Http$stringPart = _Http_pair;
var $author$project$Text$toString = function (text) {
	switch (text.$) {
		case 2:
			return '';
		case 1:
	...
	function (msg, model) {
		switch (msg.$) {
			case 2:
				...
				if (!result.$) {
					...
					var jobs = A2(
						...
						$elm$core$Dict$empty,
						A2($elm$json$Json$Decode$decodeString, $author$project$Jobs$Update$jobsDecoder, json));
					return $Fresheyeball$elm_return$Return$singleton(
						_Utils_update(
							model,
							{eG: jobs}));
			...
			case 6:
				...
				return A2(
					...
					_Utils_update(
						model,
						{
							gi: $author$project$Jobs$Types$ApplyView(jobId)
						}),
					(urlChange ? $elm$browser$Browser$Navigation$pushUrl(model.eH) : $elm$core$Basics$always($elm$core$Platform$Cmd$none))(
						A2(
							$elm$url$Url$Builder$absolute,
							_List_fromArray(
								[model.dE.e1, jobId]),
			...
			case 0:
				return A2(
					...
					A2(
						...
						_List_fromArray(
							['docx', 'pdf', 'doc', '*']),
						$author$project$Jobs$Types$Resume));
			case 4:
				var field = msg.a;
				var contents = msg.b;
				return $Fresheyeball$elm_return$Return$singleton(
					A2(
						$author$project$Jobs$Update$modifyApplicant,
						model,
						function (applicant) {
							switch (field) {
								case 0:
									return _Utils_update(
										applicant,
										{
											d8: $author$project$Text$Valid(contents)
										});
								case 1:
									return _Utils_update(
										applicant,
										{
											eJ: $author$project$Text$Valid(contents)
										});
								case 2:
									return _Utils_update(
										applicant,
										{
											dX: $author$project$Text$Valid(contents)
										});
								case 3:
									return _Utils_update(
										applicant,
										{
											bv: $author$project$Text$Valid(contents)
										});
								default:
									return _Utils_update(
										applicant,
										{
											fc: $author$project$Text$Valid(contents)
										});
							}
						}));
			case 1:
			...
			case 7:
				...
				var valid = A2(
					$elm$core$List$all,
					$author$project$Text$isValid,
					_List_fromArray(
						[model.c3.d8, model.c3.eJ, model.c3.dX, model.c3.bv, model.c3.fc]));
				return valid ? A2(
					$Fresheyeball$elm_return$Return$return,
					_Utils_update(
						model,
						{d$: $elm$core$Maybe$Nothing, fM: $elm$core$Maybe$Nothing}),
					A2(
						$elm$core$Maybe$withDefault,
						...
						A2(
							...
							function (file) {
								return $elm$http$Http$post(
									{
										dn: $elm$http$Http$multipartBody(
											_List_fromArray(
												[
													A2($elm$http$Http$stringPart, 'applicationTitle', job.bF),
													A2(
													$elm$http$Http$stringPart,
													'firstName',
													$author$project$Text$toString(model.c3.d8)),
													A2(
													$elm$http$Http$stringPart,
													'lastName',
													$author$project$Text$toString(model.c3.eJ)),
													A2(
													$elm$http$Http$stringPart,
													'email',
													$author$project$Text$toString(model.c3.dX)),
													A2(
													$elm$http$Http$stringPart,
													'phone',
													$author$project$Text$toString(model.c3.bv)),
													A2(
													$elm$http$Http$stringPart,
													'reason',
													$author$project$Text$toString(model.c3.fc)),
													A2($elm$http$Http$filePart, 'resume', file)
												])),
										d0: $elm$http$Http$expectWhatever($author$project$Jobs$Types$SendApplicantData),
										gh: model.dE.c4
									});
							},
							model.c3.fi))) : $Fresheyeball$elm_return$Return$singleton(
					_Utils_update(
						model,
						{
							d$: $elm$core$Maybe$Just('Oh no! All fields are required...')
						}));
			default:
				var result = msg.a;
				if (!result.$) {
					return $Fresheyeball$elm_return$Return$singleton(
						_Utils_update(
							model,
							{
								fM: $elm$core$Maybe$Just('Thank you for your application.')
							}));
				} else {
					return $Fresheyeball$elm_return$Return$singleton(
						_Utils_update(
							model,
							{
								d$: $elm$core$Maybe$Just('An error occurred. Please try applying again. If the problem persists, please email us your application at careers@withflint.com')
							}));
				}
		}
	});
var $author$project$Router$Types$NoOp = {$: 2};
var $author$project$Router$Types$UrlChange = $elm$core$Basics$identity;
...
var $author$project$SubReturn$returnCmd = F2(
	function (model, cmd) {
		return _Utils_Tuple2(
			model,
			$uncover_co$elm_submodules$SubCmd$cmd(cmd));
	});
var $author$project$SubReturn$returnSub = F2(
	function (model, subCmd) {
		return _Utils_Tuple2(model, subCmd);
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var url = msg.a;
				return A2(
					$author$project$SubReturn$returnSub,
					_Utils_update(
						model,
						{
							e1: A2(
					...
					$uncover_co$elm_submodules$SubCmd$batch(
						_List_fromArray(
							[
								...
								A2(
									$elm$core$Task$perform,
									$elm$core$Basics$always($author$project$Router$Types$NoOp),
									A2($elm$browser$Browser$Dom$setViewport, 0, 0))),
								$uncover_co$elm_submodules$SubCmd$effect(url)
							])));
			case 1:
				...
				if (!urlRequest.$) {
					...
					return A2(
						$author$project$SubReturn$returnCmd,
						model,
						A2(
			...
			default:
				return $author$project$SubReturn$singletonSub(model);
		}
	});
var $uncover_co$elm_submodules$SubModule$update = F2(
	function (config, _v0) {
		var subModel = _v0.a;
		var subCmd = _v0.b;
		return _Utils_Tuple2(
...
var $author$project$Update$pageTitle = function (model) {
	var _v0 = model.fk.e1;
	switch (_v0.$) {
		case 1:
			return '404 Not Found - Flint';
		case 2:
			return model.dF.bF;
		case 3:
			return model.eG.bF;
...
var $author$project$Update$updateTitle = function (model) {
	return _Utils_update(
		model,
		{
			bF: $author$project$Update$pageTitle(model)
		});
};
...
var $author$project$Update$update = F2(
	function (msg, model) {
		return A2(
			$Fresheyeball$elm_return$Return$map,
			$author$project$Update$updateTitle,
			function () {
				switch (msg.$) {
					case 0:
						var routerMsg = msg.a;
						return A2(
							...
							{
								bV: $author$project$Types$EffFromRouter,
								S: function (router) {
									return _Utils_update(
										model,
										{fk: router});
								},
								w: $author$project$Types$MsgForRouter
							},
							A2($author$project$Router$Update$update, routerMsg, model.fk));
					case 2:
						var jobsMsg = msg.a;
						return A2(
							$uncover_co$elm_submodules$SubModule$update,
							{
								S: function (jobs) {
									return _Utils_update(
										model,
							...
							A2($author$project$Jobs$Update$update, jobsMsg, model.eG));
					case 3:
						var healthCareMsg = msg.a;
						return A2(
							$uncover_co$elm_submodules$SubModule$update,
							{
								S: function (healthCare) {
									return _Utils_update(
										model,
										{el: healthCare});
								},
							...
							A2($author$project$Jobs$Update$update, healthCareMsg, model.el));
					case 4:
						var blogMsg = msg.a;
						return A2(
							$uncover_co$elm_submodules$SubModule$update,
							...
							A2($author$project$Blog$Update$update, blogMsg, model.dk));
					case 5:
						var faqNursesMsg = msg.a;
						return A2(
							$uncover_co$elm_submodules$SubModule$update,
							{
								S: function (faqNurses) {
									return _Utils_update(
										model,
										{d3: faqNurses});
								},
							...
							A2($author$project$FaqNurses$Update$update, faqNursesMsg, model.d3));
					case 1:
						var eff = msg.a;
						var url = eff;
						var _v2 = $author$project$Router$Routes$parse(url);
						_v2$3:
						while (true) {
							if (!_v2.$) {
								switch (_v2.a.$) {
									case 5:
										...
										return A2(
											...
											A2(
												$author$project$Blog$Update$update,
												$author$project$Blog$Types$LoadArticle(article),
												model.dk));
									case 3:
										var jobId = _v2.a.a;
										return A2(
											...
											A2(
												$author$project$Jobs$Update$update,
												$author$project$Jobs$Types$SwitchView(
													$author$project$Jobs$Types$ApplyView(jobId)),
												model.eG));
									case 4:
										var jobId = _v2.a.a;
										return A2(
					...
					case 6:
						...
						return $Fresheyeball$elm_return$Return$singleton(
							_Utils_update(
								model,
								{
									dU: $author$project$Device$classify(
										{
											bm: $elm$core$Basics$round(viewport.cJ.bm),
											cK: $elm$core$Basics$round(viewport.cJ.cK)
										})
								}));
					default:
						var width = msg.a;
...
var $author$project$Styles$font = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								ep: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{d9: $elm$core$Maybe$Nothing, ep: $elm$core$Maybe$Nothing, eR: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.fj, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.fv]))),
...
var $author$project$Styles$paragraph = _List_fromArray(
	[
		...
		$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$colors.ec),
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dG + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.av)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.av + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.O)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$View$notFound = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$colors.U),
		...
		[
				...
				[
					...
					_List_Nil,
					{
						_: A2(
							...
							{dR: 'Flint', B: '/static/images/logo-white.svg'}),
						gh: $author$project$Router$Routes$toPath($author$project$Router$Routes$Home)
					})
				])),
			A2(
			$mdgriffith$elm_ui$Element$row,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('404: Oops! We could not find that page. ')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$row,
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								_: $mdgriffith$elm_ui$Element$text('Go home!'),
								gh: $author$project$Router$Routes$toPath($author$project$Router$Routes$Home)
							})
						]))
				]))
...
var $author$project$Styles$headFont = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
...
var $dillonkearns$elm_markdown$Markdown$Parser$deadEndToString = function (deadEnd) {
	return 'Problem at row ' + ($elm$core$String$fromInt(deadEnd.fl) + ('\n' + $dillonkearns$elm_markdown$Markdown$Parser$problemToString(deadEnd.e8)));
};
var $elm$html$Html$br = _VirtualDom_node('br');
var $author$project$Styles$codeFont = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
...
var $author$project$Blog$View$code = function (snippet) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Styles$codeFont
			]),
...
var $author$project$Blog$View$codeBlock = function (details) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text(details.dn));
};
...
var $mdgriffith$elm_ui$Element$Font$center = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.fW);
...
var $mdgriffith$elm_ui$Internal$Model$boxShadowClass = function (shadow) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				shadow.b8 ? 'box-inset' : 'box-',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.ao.a) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.ao.b) + 'px',
...
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {aj: almostShade.aj, ak: almostShade.ak, b8: false, ao: almostShade.ao, ap: almostShade.ap};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var $author$project$Blog$View$rawTextToId = function (rawText) {
...
var $author$project$Blog$View$heading = function (_v0) {
	var level = _v0.eK;
	var rawText = _v0.fb;
	var children = _v0.dy;
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					'name',
					$author$project$Blog$View$rawTextToId(rawText))),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$elm$html$Html$Attributes$id(
					$author$project$Blog$View$rawTextToId(rawText))),
				$author$project$Styles$headFont,
...
var $mdgriffith$elm_ui$Element$Font$strike = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.fG);
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.av + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.O + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bJ)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
...
var $author$project$Blog$View$elmUiRenderer = {
	dj: function (children) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
	...
	dC: $author$project$Blog$View$codeBlock,
	dD: $author$project$Blog$View$code,
	dY: function (content) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
	...
	ej: $mdgriffith$elm_ui$Element$html(
		A2($elm$html$Html$br, _List_Nil, _List_Nil)),
	ek: $author$project$Blog$View$heading,
	...
	es: function (image) {
		...
		if (!_v0.$) {
			...
			return A2(
				...
				{dR: image.c$, B: image.B});
		}
	},
	eL: F2(
		function (_v1, body) {
			var destination = _v1.dT;
			return A2(
				...
				{
					_: A2($mdgriffith$elm_ui$Element$paragraph, $author$project$Styles$link, body),
					gh: destination
				});
		}),
	e_: F2(
	...
	e3: $mdgriffith$elm_ui$Element$paragraph($author$project$Styles$paragraph),
	fH: function (content) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
	...
	fN: $mdgriffith$elm_ui$Element$column(_List_Nil),
	fO: $mdgriffith$elm_ui$Element$column(_List_Nil),
	fP: F2(
		function (_v2, children) {
			return A2($mdgriffith$elm_ui$Element$paragraph, _List_Nil, children);
		}),
	fQ: $mdgriffith$elm_ui$Element$column(_List_Nil),
	fR: F2(
		function (_v3, children) {
			return A2($mdgriffith$elm_ui$Element$paragraph, _List_Nil, children);
		}),
	fS: $mdgriffith$elm_ui$Element$row(_List_Nil),
	fV: $mdgriffith$elm_ui$Element$text,
	f7: $mdgriffith$elm_ui$Element$none,
	gf: function (items) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bT: col, f: s0.f, h: s0.h, ao: offset, fl: row, B: s0.B});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.ao, s.fl, s.bT, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bT: col, dH: contextStack, e8: problem, fl: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.fl, s.bT, x, s.f));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.ao, s.fl, s.bT, s.B);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bT: newCol, f: s.f, h: s.h, ao: newOffset, fl: newRow, B: s.B});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.ao, s1.ao, s0.B),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.ao, s.B);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{bT: 1, f: s.f, h: s.h, ao: s.ao + 1, fl: s.fl + 1, B: s.B}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{bT: s.bT + 1, f: s.f, h: s.h, ao: newOffset, fl: s.fl, B: s.B}));
		};
	});
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.ao, s.fl, s.bT, s.B);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.ao, adjustedOffset) < 0,
			0,
			{bT: newCol, f: s.f, h: s.h, ao: adjustedOffset, fl: newRow, B: s.B});
	};
};
...
var $dillonkearns$elm_markdown$Markdown$OrderedList$ListItem = F4(
	function (order, intended, marker, body) {
		return {dn: body, eC: intended, eO: marker, eZ: order};
	});
var $elm$parser$Parser$Advanced$getCol = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.bT, s);
};
...
var $dillonkearns$elm_markdown$Markdown$Parser$orderedListBlock = function (previousWasBody) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (item) {
			return A6($dillonkearns$elm_markdown$Markdown$RawBlock$OrderedListBlock, true, item.eC, item.eO, item.eZ, _List_Nil, item.dn);
		},
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return $dillonkearns$elm_markdown$Markdown$Inline$Text(match.fV);
		case 1:
			return $dillonkearns$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return $dillonkearns$elm_markdown$Markdown$Inline$CodeInline(match.fV);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return {g: childMatch.g - parentMatch.q, o: childMatch.o, i: childMatch.i - parentMatch.q, fV: childMatch.fV, v: childMatch.v - parentMatch.q, q: childMatch.q - parentMatch.q, gd: childMatch.gd};
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {c: index, ax: match, eT: number, bD: submatches};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		o: _List_Nil,
		i: 0,
		fV: $dillonkearns$elm_markdown$Markdown$Helpers$formatStr(text),
		v: 0,
		q: 0,
		gd: $dillonkearns$elm_markdown$Markdown$InlineParser$NormalType
	};
};
var $dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = {
			g: matchModel.g,
			o: A3($dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.fV, _List_Nil, matchModel.o),
			i: matchModel.i,
			fV: matchModel.fV,
			v: matchModel.v,
			q: matchModel.q,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, bq: 1, d: $dillonkearns$elm_markdown$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToCodeToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $elm$core$Maybe$Just(
			{
				c: regMatch.c + backslashesLength,
				bq: $elm$core$String$length(backtick),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{c: (regMatch.c + backslashesLength) - 1, bq: 2, d: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							c: regMatch.c,
							bq: $elm$core$String$length(regMatch.ax),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{c: regMatch.c + backslashesLength, bq: 1, d: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{c: (regMatch.c + backslashesLength) - 1, bq: 2, d: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, bq: 1, d: $dillonkearns$elm_markdown$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{c: index, bq: 2, d: $dillonkearns$elm_markdown$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						c: index,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, bq: length, d: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	A2(
		...
		function (match) {
			return A2(
				$elm$core$Maybe$withDefault,
				match.ax,
				$elm$url$Url$percentDecode(match.ax));
		}));
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$urlRegex, match.fV) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				gd: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.fV,
						$dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.fV)))
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$refRegexToMatch = F3(
	function (matchModel, references, maybeRegexMatch) {
		var refLabel = function (str) {
			return $elm$core$String$isEmpty(str) ? matchModel.fV : str;
		}(
			A2(
				$elm$core$Maybe$withDefault,
				matchModel.fV,
		...
		if (_v0.$ === 1) {
			...
			var regexMatchLength = function () {
				if (!maybeRegexMatch.$) {
					var match = maybeRegexMatch.a.ax;
			...
			return $elm$core$Maybe$Just(
				_Utils_update(
					matchModel,
					{g: matchModel.g + regexMatchLength, gd: type_}));
		}
	});
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						g: matchModel.g + $elm$core$String$length(regexMatch.ax),
						gd: function () {
							var _v5 = matchModel.gd;
							if (_v5.$ === 5) {
								return $dillonkearns$elm_markdown$Markdown$InlineParser$ImageType;
							} else {
								return $dillonkearns$elm_markdown$Markdown$InlineParser$LinkType;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$emailRegex, match.fV) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				gd: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.fV,
						'mailto:' + $dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.fV)))
			})) : $elm$core$Result$Err(match);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bT: 1, f: _List_Nil, h: 1, ao: 0, fl: 1, B: src});
		if (!_v1.$) {
			var value = _v1.b;
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {b5: htmlTag, bq: endOffset - startOffset};
							})),
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$isCodeTokenPair = F2(
	function (closeToken, openToken) {
		...
		if (!_v0.$) {
			if (!_v0.a) {
				var _v1 = _v0.a;
				return _Utils_eq(openToken.bq - 1, closeToken.bq);
			} else {
				var _v2 = _v0.a;
				return _Utils_eq(openToken.bq, closeToken.bq);
			}
		} else {
			return false;
		}
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.aW, open.aZ) || _Utils_eq(close.aW, close.aZ)) ? ((!(!A2($elm$core$Basics$modBy, 3, closeToken.bq + openToken.bq))) || ((!A2($elm$core$Basics$modBy, 3, closeToken.bq)) && (!A2($elm$core$Basics$modBy, 3, openToken.bq)))) : true) : false;
			} else {
				return false;
			}
		} else {
	...
	function (closeToken, openToken) {
		var _v0 = function () {
			...
			if (_v1.$ === 10) {
				if (!_v1.a) {
					var _v2 = _v1.a;
					return _Utils_Tuple2(true, openToken.bq - 1);
				} else {
					var _v3 = _v1.a;
					return _Utils_Tuple2(true, openToken.bq);
				}
			} else {
		...
		var _v4 = function () {
			...
			if (_v5.$ === 10) {
				if (!_v5.a) {
					var _v6 = _v5.a;
					return _Utils_Tuple2(true, closeToken.bq - 1);
				} else {
					var _v7 = _v5.a;
					return _Utils_Tuple2(true, closeToken.bq);
				}
			} else {
				return _Utils_Tuple2(false, 0);
			}
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {g: token.c + token.bq, o: _List_Nil, i: token.c, fV: '', v: 0, q: 0, gd: type_};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$codeToMatch = F5(
	function (closeToken, matches, references, rawText, _v34) {
		...
		var updatedOpenToken = function () {
			var _v35 = openToken.d;
			if ((!_v35.$) && (!_v35.a)) {
				var _v36 = _v35.a;
				return _Utils_update(
					openToken,
					{c: openToken.c + 1, bq: openToken.bq - 1});
			} else {
				return openToken;
			}
		}();
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v27) {
		...
		var remainLength = openToken.bq - closeToken.bq;
		var updt = (!remainLength) ? {aK: closeToken, ay: openToken, aY: remainTokens, a6: tokensTail} : ((remainLength > 0) ? {
			aK: closeToken,
			ay: _Utils_update(
				openToken,
				{c: openToken.c + remainLength, bq: closeToken.bq}),
			aY: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			a6: A2(
				...
				_Utils_update(
					closeToken,
					{c: closeToken.c + openToken.bq, bq: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$dillonkearns$elm_markdown$Markdown$InlineParser$EmphasisType(updt.ay.bq),
			updt.ay,
			updt.aK,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.a6, match, updt.aY);
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F7(
	function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.c + openToken.bq;
		var textEnd = closeToken.c;
		var text = processText(
			A3($elm$core$String$slice, textStart, textEnd, rawText));
		var start = openToken.c;
		var end = closeToken.c + closeToken.bq;
		var match = {g: end, o: _List_Nil, i: start, fV: text, v: textEnd, q: textStart, gd: type_};
		var matches = A2(
			$elm$core$List$map,
			function (_v0) {
				var matchModel = _v0;
		...
		return {g: end, o: matches, i: start, fV: text, v: textEnd, q: textStart, gd: type_};
	});
			...
			return A3(
				...
				F2(
					function (headerCell, alignment) {
						return {aE: alignment, _: headerCell};
					}),
				headers,
				columnAlignments);
		};
...
var $dillonkearns$elm_markdown$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$backtick = {aI: '`', aV: 0, a5: $dillonkearns$elm_markdown$Parser$Token$backtick};
	...
	function (minLength, fenceCharacter) {
		var builtTokens = A3(
			...
			A2(
				...
				minLength,
				$elm$parser$Parser$Advanced$token(fenceCharacter.a5)));
		return A2(
			$elm$parser$Parser$Advanced$mapChompedString,
			F2(
				function (str, _v0) {
...
var $dillonkearns$elm_markdown$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$tilde = {aI: '~', aV: 1, a5: $dillonkearns$elm_markdown$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {aJ: character, bp: indent, bq: length};
					})),
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$Advanced$succeed(
						$elm$parser$Parser$Advanced$Done(body)),
					A2($dillonkearns$elm_markdown$Markdown$CodeBlock$closingFence, fence.bq, fence.aJ))),
				A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$keeper,
					A2(
						...
						$dillonkearns$elm_markdown$Markdown$CodeBlock$codeBlockLine(fence.bp)),
					$elm$parser$Parser$Advanced$getOffset),
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.ao, s.fl, s.bT, s.B);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {bT: col, f: context, fl: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {bT: s.bT, f: newContext, h: s.h, ao: s.ao, fl: s.fl, B: s.B};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.fl, s0.bT, context),
						s0.f),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
		...
		F2(
			function (delimiterText, revDelimiterColumns) {
				return A2(
					...
					{
						cp: delimiterText,
						cG: $elm$core$String$trim(delimiterText)
					},
					A2(
						$elm$core$List$map,
		...
		function (listmarker, intended, unparsedListItem) {
			switch (unparsedListItem.$) {
				...
				case 1:
					...
					return {dn: body, eO: listmarker, k: $elm$core$Maybe$Nothing};
				default:
					return {dn: '', eO: listmarker, k: $elm$core$Maybe$Nothing};
			}
		});
	return A2(
		$elm$parser$Parser$Advanced$map,
							...
							return $elm$parser$Parser$Advanced$succeed(
								{
									...
									b: A2(
										...
										$dillonkearns$elm_markdown$Markdown$RawBlock$CodeBlock(
											{
												dn: A2($dillonkearns$elm_markdown$Markdown$Parser$joinStringsPreserveAll, block2.dn, block1.dn),
					...
					case 3:
						...
						switch (newRawBlock.$) {
							case 3:
								...
								if (_Utils_eq(openListItem2.eO, openListItem1.eO)) {
									var _v52 = A2(
										$elm$parser$Parser$Advanced$run,
										$dillonkearns$elm_markdown$Markdown$Parser$cyclic$rawBlockParser(),
										openListItem2.dn);
										...
										b: A2(
											...
											A4(
												...
												_Utils_update(
													openListItem2,
													{
														dn: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '\n', openListItem2.dn, body1)
													})),
											rest)
									});
							default:
	...
	function (linkReferences, rawBlock) {
		switch (rawBlock.$) {
					...
					A2(
						...
						$elm$core$List$reverse(
							A2(
								$elm$core$List$map,
								function (item) {
									return A2(parseItem, item.k, item.dn);
								},
								unparsedItems))));
			case 4:
				var tight = rawBlock.a;
			...
			case 6:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$CodeBlock(
						{dn: codeBlockBody, eI: $elm$core$Maybe$Nothing}));
			case 8:
				var _v22 = rawBlock.a;
				var header = _v22.a;
				var rows = _v22.b;
			...
			case 9:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
						A2($dillonkearns$elm_markdown$Markdown$Parser$inlineParseHelper, linkReferences, text.cp)));
			default:
				var raw = rawBlock.b;
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
													...
													A2(
														...
														A4(
															...
															_Utils_update(
																openListItem,
																{
																	dn: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '', openListItem.dn, newString)
																})),
														rest))
											});
									});
								...
								if (_v3.b.b) {
									switch (_v3.b.a.$) {
										case 3:
											...
											return ($elm$core$String$trim(openListItem.dn) === '') ? A2(
												$elm$parser$Parser$Advanced$map,
												function (block) {
													return $elm$parser$Parser$Advanced$Loop(block);
												},
	...
	return function (block) {
		switch (block.$) {
							...
							return renderer.ek(
								{
									dy: children,
									eK: level,
									fb: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(content)
								});
						},
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.dC(codeBlock)));
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.f7));
			case 3:
								...
								renderer.fS(
									A2(
										...
										function (_v10) {
											...
											var item = _v10.b;
											return A2(renderer.fR, maybeAlignment, item);
										},
										listListView))));
					},
					renderedHeaderCells);
			...
			case 2:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.es(
							{
								c$: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(children),
								B: src,
								bF: title
							})));
			case 7:
...
var $author$project$Blog$View$markdownView = function (markdown) {
	return A2(
		$elm$core$Result$andThen,
		$dillonkearns$elm_markdown$Markdown$Renderer$render($author$project$Blog$View$elmUiRenderer),
		A2(
			$elm$core$Result$mapError,
			function (error) {
				return A2(
...
var $author$project$Blog$View$oops = $mdgriffith$elm_ui$Element$text('Oops! We can\'t find that.');
var $author$project$Blog$View$articlePhoneView = function (article) {
	return _List_fromArray(
		[
			function () {
			var _v0 = $author$project$Blog$View$markdownView(article.dn);
			if (!_v0.$) {
				var rendered = _v0.a;
				return A2(
					$mdgriffith$elm_ui$Element$column,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(article.bF)
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$Font$underline]),
									{
										_: $mdgriffith$elm_ui$Element$text(article.bN),
										gh: article.eL
									}),
									A2(
									$mdgriffith$elm_ui$Element$el,
									...
									$mdgriffith$elm_ui$Element$el,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text(article.df))
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_Nil,
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$colors.aR),
											$mdgriffith$elm_ui$Element$Font$size(14)
										]),
									$mdgriffith$elm_ui$Element$text(article.dN))
								])),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_Utils_ap(
							...
							A2(
								...
								A2(
									...
									{dR: article.eP.dR, B: '/static/images/blog/' + (article.fx + '.jpeg')}),
								rendered))
						]));
			} else {
				return $author$project$Blog$View$oops;
			}
		}()
		]);
};
var $author$project$Blog$View$hr = F3(
	function (f, index, article) {
		return _List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Element$column,
				...
				_Utils_ap(
					(!index) ? _List_Nil : _List_fromArray(
						[
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$paddingEach(
									{W: 15, aa: 0, af: 0, ag: 0}),
									$mdgriffith$elm_ui$Element$Border$color($author$project$Styles$colors.gk)
								]),
							$mdgriffith$elm_ui$Element$text(''))
						]),
					f(article)))
...
var $author$project$Blog$View$loading = $mdgriffith$elm_ui$Element$text('Loading...');
...
var $author$project$Blog$View$phoneSummaryView = function (article) {
	var go = function (ele) {
		return A2(
			$mdgriffith$elm_ui$Element$link,
			_List_fromArray(
				...
				]),
			{
				_: ele,
				gh: $author$project$Router$Routes$toPath(
					$author$project$Router$Routes$Blog(article.fx))
			});
	};
	return _List_fromArray(
		[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(article.fK)
									]))
							]))),
					go(
					A2(
...
var $author$project$Blog$View$blogPhoneView = function (article) {
	switch (article.$) {
		case 0:
			return _List_fromArray(
				[$author$project$Blog$View$loading]);
		case 3:
			return _List_fromArray(
				[$author$project$Blog$View$oops]);
		case 1:
			...
			return _List_fromArray(
				[
					...
					A2(
						...
						A2(
							$elm$core$List$indexedMap,
							$author$project$Blog$View$hr($author$project$Blog$View$phoneSummaryView),
							articles)))
				]);
		default:
			var article_ = article.a;
			return $author$project$Blog$View$articlePhoneView(article_);
	}
};
var $author$project$Blog$View$articleView = function (article) {
	return _List_fromArray(
		[
			function () {
			var _v0 = $author$project$Blog$View$markdownView(article.dn);
...
var $author$project$Blog$View$summaryView = function (article) {
	return _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$link,
						...
						[
							...
							_List_fromArray(
								[
									...
									{dR: article.bN, B: article.c8}),
									$mdgriffith$elm_ui$Element$text(article.bN),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text('·')),
...
var $author$project$Blog$View$blogView = function (article) {
	switch (article.$) {
		case 0:
			return _List_fromArray(
				[$author$project$Blog$View$loading]);
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$width(
							A2($mdgriffith$elm_ui$Element$maximum, 850, $mdgriffith$elm_ui$Element$fill)),
							A2($mdgriffith$elm_ui$Element$paddingXY, 80, 40),
					...
					A2(
						...
						A2(
							$elm$core$List$indexedMap,
							$author$project$Blog$View$hr($author$project$Blog$View$summaryView),
							articles)))
				]);
		default:
			var article_ = article.a;
			return $author$project$Blog$View$articleView(article_);
	}
};
...
var $author$project$Layout$menu = _List_fromArray(
	[
		_Utils_Tuple2($author$project$Router$Routes$Home, 'Home'),
		_Utils_Tuple2(
		$author$project$Router$Routes$NurseCareers(''),
		'Nurse Careers'),
		_Utils_Tuple2($author$project$Router$Routes$Contact, 'Contact'),
		_Utils_Tuple2(
		$author$project$Router$Routes$JoinTheTeam(''),
		'Join the Team'),
		_Utils_Tuple2(
...
var $author$project$Layout$footer = function () {
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									{dR: 'Flint', B: '/static/images/logo.svg'})
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[$mdgriffith$elm_ui$Element$Font$underline]),
											{
												_: $mdgriffith$elm_ui$Element$text('Privacy Policy'),
												gh: '/privacy'
											})
										]))
								]))
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($mdgriffith$elm_ui$Element$spacingXY, 60, 0),
									$mdgriffith$elm_ui$Element$centerX,
									$mdgriffith$elm_ui$Element$alignRight
								]),
							_List_fromArray(
										...
										[
											...
											_List_Nil,
											{
												_: A2(
													...
													{dR: 'Flint', B: '/static/images/YC_logo.svg'}),
												gh: 'https://www.ycombinator.com/companies/flint'
											})
										])),
									A2(
									$mdgriffith$elm_ui$Element$row,
										...
										[
											...
											_List_Nil,
											{
												_: A2(
													...
													{dR: 'Flint', B: '/static/images/github_logo.svg'}),
												gh: 'https://github.com/withflint'
											})
										])),
									A2(
									$mdgriffith$elm_ui$Element$row,
										...
										[
											...
											_List_Nil,
											{
												_: A2(
													...
													{dR: 'Flint', B: '/static/images/linkedin-icon-2.svg'}),
												gh: 'https://www.linkedin.com/company/withflint/'
											})
										]))
								]))
						]))
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											{
												_: $mdgriffith$elm_ui$Element$text(label),
												gh: $author$project$Router$Routes$toPath(path)
											})
										]));
							},
							$author$project$Layout$menu))
					])),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
...
var $author$project$Layout$header = function () {
	var _default = _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$row,
...
var $author$project$Blog$View$view = function (model) {
	return {
		bh: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						A2($mdgriffith$elm_ui$Element$paddingXY, 100, 40)
					]),
				_Utils_ap(
					$author$project$Layout$header.bh,
					_Utils_ap(
						$author$project$Blog$View$blogView(model.c6),
						$author$project$Layout$footer.bh)))
			]),
		bv: _List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Layout$header.bv,
					_Utils_ap(
						$author$project$Blog$View$blogPhoneView(model.c6),
						$author$project$Layout$footer.bv)))
			]),
		bE: _List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Layout$header.bE,
					_Utils_ap(
						$author$project$Blog$View$blogView(model.c6),
						$author$project$Layout$footer.bE)))
			])
	};
};
var $author$project$Contact$View$copy = {a0: 'To learn more about what an optimized staffing solution looks like, meet with our partnership team.', a1: 'Healthcare Partnerships', a2: 'Are you an internationally educated nurse? We can help you relocate to the United States of America; we offer all-inclusive packages, including immigration, green cards, transport, accommodations and the best job offers. Text, call or email us!', a3: 'Nurse Talent Team'};
					...
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Border$color($author$project$Styles$colors.as),
								$mdgriffith$elm_ui$Element$Border$rounded(3),
								$mdgriffith$elm_ui$Element$Border$shadow(
								{
									aj: 8,
									ak: $author$project$Styles$colors.am,
									ao: _Utils_Tuple2(0, 0),
									ap: 2
								}),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text($author$project$Contact$View$copy.a1)
									])),
								A2(
								$mdgriffith$elm_ui$Element$row,
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text($author$project$Contact$View$copy.a0)
											]))
									])),
								A2(
								$mdgriffith$elm_ui$Element$row,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[$mdgriffith$elm_ui$Element$centerX]),
										$mdgriffith$elm_ui$Element$text('healthcare@withflint.com'))
									])),
								A2(
								$mdgriffith$elm_ui$Element$row,
								_Utils_ap(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[$mdgriffith$elm_ui$Element$centerX]),
										$mdgriffith$elm_ui$Element$text('+1 (844) 677-1180'))
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text($author$project$Contact$View$copy.a3)
									])),
								A2(
								$mdgriffith$elm_ui$Element$row,
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text($author$project$Contact$View$copy.a2)
											]))
									])),
								A2(
								$mdgriffith$elm_ui$Element$row,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[$mdgriffith$elm_ui$Element$centerX]),
										$mdgriffith$elm_ui$Element$text('talent@withflint.com'))
									])),
								A2(
								$mdgriffith$elm_ui$Element$row,
								_Utils_ap(
...
var $author$project$Styles$buttons = {
	...
	a$: _Utils_ap(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$colors.aR)
			]))
};
								...
								_List_fromArray(
									[
										...
										_Utils_ap(
											$author$project$Styles$paragraph,
											_Utils_ap(
												$author$project$Styles$buttons.aX,
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$width(
										...
										{
											_: $mdgriffith$elm_ui$Element$text('healthcare@withflint.com'),
											gh: 'mailto:healthcare@withflint.com'
										}),
										A2(
										$mdgriffith$elm_ui$Element$link,
										_Utils_ap(
											$author$project$Styles$paragraph,
											_Utils_ap(
												$author$project$Styles$buttons.a$,
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$width(
														A2($mdgriffith$elm_ui$Element$maximum, 240, $mdgriffith$elm_ui$Element$fill)),
														...
														_List_fromArray(
															[
																$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$colors.ec)
															]))
													]))),
										{
											_: $mdgriffith$elm_ui$Element$text('+1 (844) 677-1180'),
											gh: 'tel:+1 (844) 677-1180'
										})
									]))
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										{
											_: $mdgriffith$elm_ui$Element$text('talent@withflint.com'),
											gh: 'mailto:talent@withflint.com'
										}),
										A2(
										$mdgriffith$elm_ui$Element$link,
										_Utils_ap(
...
var $author$project$Contact$View$view = function (_v0) {
	return {
		bh: _List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Layout$header.bh,
					_Utils_ap($author$project$Contact$View$desktopLayout, $author$project$Layout$footer.bh)))
			]),
		bv: _List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Layout$header.bv,
					_Utils_ap($author$project$Contact$View$phoneLayout, $author$project$Layout$footer.bv)))
			]),
		bE: _List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Layout$header.bE,
					_Utils_ap($author$project$Contact$View$tabletLayout, $author$project$Layout$footer.bE)))
			])
	};
};
var $author$project$FaqNurses$View$desktopHeader = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$FaqNurses$View$faqHeroTitleDesktop = function (title) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
...
var $author$project$FaqNurses$View$faqHeroTitlePhone = function (title) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		case 1:
			...
			return styled.eq(
				A2(
					...
					{
						d9: {c9: $elm$core$Maybe$Nothing, dp: $elm$core$Maybe$Nothing, fu: $elm$core$Maybe$Nothing},
						ep: 1,
						eR: 0
					},
					styled.fJ));
...
var $author$project$FaqNurses$Types$ToggleVisibility = $elm$core$Basics$identity;
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aO + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.O + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.fq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cd)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$FaqNurses$View$collapseOrExpandBtn = F2(
	function (icon, id) {
		return A2(
...
var $author$project$FaqNurses$View$viewAnswer = function (answer) {
	if (!answer.$) {
		var str = answer.a;
		return A2(
			$mdgriffith$elm_ui$Element$paragraph,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Styles$font,
							$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$colors.bg)
						]),
...
var $mdgriffith$elm_ui$Element$Font$medium = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.f1);
var $author$project$FaqNurses$View$viewQuestion = F2(
				...
				]),
			{
				_: A2(
					...
					A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_fromArray(
							[$author$project$Styles$headFont, $mdgriffith$elm_ui$Element$alignLeft, $mdgriffith$elm_ui$Element$Font$medium, $author$project$Styles$headFont]),
						_List_fromArray(
							[
...
var $author$project$FaqNurses$View$viewAFaq = F2(
	function (index, faq) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3($mdgriffith$elm_ui$Element$Lazy$lazy2, $author$project$FaqNurses$View$viewQuestion, faq.er, faq.fa),
							faq.eE ? A2($author$project$FaqNurses$View$collapseOrExpandBtn, '×', faq.er) : A2($author$project$FaqNurses$View$collapseOrExpandBtn, '+', faq.er)
						])),
					faq.eE ? A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
					...
					A2($elm$core$List$map, $author$project$FaqNurses$View$viewAnswer, faq.c1)) : A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$none)
				]));
	});
var $author$project$FaqNurses$View$faqsView = function (_v0) {
	var faqs = _v0.d4;
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
		...
		A2(
			$elm$core$List$indexedMap,
			$mdgriffith$elm_ui$Element$Lazy$lazy2($author$project$FaqNurses$View$viewAFaq),
			faqs));
};
var $author$project$FaqNurses$View$phoneHeader = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$FaqNurses$View$view = function (model) {
	return {
		bh: _List_fromArray(
			[
				$author$project$FaqNurses$View$desktopHeader,
				$author$project$FaqNurses$View$faqHeroTitleDesktop(model.em),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
				...
				A2(
					$elm$core$List$cons,
					$author$project$FaqNurses$View$faqsView(model),
					$author$project$Layout$footer.bh))
			]),
		bv: _List_fromArray(
			[
				$author$project$FaqNurses$View$phoneHeader,
				$author$project$FaqNurses$View$faqHeroTitlePhone(model.em),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
...
var $author$project$Home$View$copy = {
	dd: 'We Source the Best Nurses',
	de: 'Flint has the best nurses. Just ask anyone who’s met our candidates. With an international sourcing team that sources from the entire world, we receive a lot of applications, thousands per year in fact. With such a large pool of nurses, we’re able to screen and select the best candidates for your needs.',
	bc: 'Fully Managed Concierge Experience',
	bd: _List_fromArray(
		[
			_Utils_Tuple2('• ', 'Candidate sourcing'),
			_Utils_Tuple2('• ', 'Candidate screening'),
			_Utils_Tuple2('• ', 'Credential verification'),
			_Utils_Tuple2('• ', 'NCLEX Preparation'),
			_Utils_Tuple2('• ', 'Language examination'),
			_Utils_Tuple2('• ', 'Licensing in the state of practice'),
			_Utils_Tuple2('• ', 'Immigration management'),
			_Utils_Tuple2('• ', 'Representation with the government'),
			_Utils_Tuple2('• ', 'Arrival and settlement assistance'),
			_Utils_Tuple2('• ', 'Travel assistance'),
			_Utils_Tuple2('• ', 'Support for family members'),
			_Utils_Tuple2('• ', 'Dedicated relocation & cultural advisor for the nurse (3 years)')
		]),
	be: 'We understand that you’re very busy and have a lot on your plate. That’s why you can expect us to fully manage the entire recruiting, licensing, immigration, and relocation process. ',
	bf: 'All you have to do is select the candidates you want to hire and onboard them when they walk into your door. We’ll do all the heavy lifting throughout the process, including:',
	d5: 'Fastest Immigration Possible',
	d6: 'Most firms will only try one immigration path. At Flint, our in-house legal team, empowered by custom built computer technology, designs personalized plans for each nurse. We leverage many possible paths, including lotteries, to get your nurse working ASAP. ',
	bi: 'Flint Can Help',
	bj: _List_fromArray(
		[
			_Utils_Tuple2('• ', 'Decrease your staffing costs by over 50%'),
			_Utils_Tuple2('• ', 'Remove your reliance on travel nurses'),
			_Utils_Tuple2('• ', 'Recruit incredible nurses with 3-10 years of experience (employed directly by your organization)'),
			_Utils_Tuple2('• ', 'Build a long term recruitment funnel to never be short nurses again'),
			_Utils_Tuple2('• ', 'Improve your quality of care with passionate nurses')
		]),
	eh: 'Hospital Guarantee',
	ei: 'If the nurse just isn’t working out within your organization and you choose to end the employment, we’ll provide you with a prorated refund. We can offer this guarantee because our nurses are such strong candidates. ',
	fr: 'Secure your nurses',
	fs: 'To learn more about how easy it is to work with Flint. Set up a meeting with one of our partnership managers to get started.',
	bA: 'Your Long Term Staffing Solution',
	bB: 'At Flint, our goal is to help you secure your long term staffing needs. We help by sourcing the best registered nurses from around the globe, providing you with a steady and reliable stream of experienced nurses who are employed directly by your organization. ',
	fA: 'Nurses that meet the highest standards',
	fB: 'Every nurse we recruit is carefully screened and vetted by our Talent Team to ensure they can communicate effectively in English, have the appropriate experience for your needs, and possess the right attitude to succeed in the United States. When it comes to the final selection, you’re in control. Our team will work alongside yours to facilitate the selection process, and present candidates tailored to your specific hiring needs.',
	fT: 'An Experienced and Proven Team',
	fU: 'We’re a veteran team of health care professionals, immigration lawyers, and engineers who are passionate about solving the nursing shortage in America while removing barriers for nurses to immigrate and build a new life in our country. With experience immigrating and placing hundreds of nurses across 40+ states, our team stands ready to help you succeed. ',
	cC: 'Securing Nurses for Your Future'
};
var $author$project$Home$View$wf = $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill);
var $author$project$Home$View$expand = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
			$author$project$Home$View$wf
		]),
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('')
		]));
var $author$project$Home$View$h2w = function (t) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
			[
...
var $author$project$Home$View$leftCta = function (_v0) {
	var url = _v0.a;
	var t = _v0.b;
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			_List_fromArray(
				[$author$project$Home$View$wf, $mdgriffith$elm_ui$Element$centerX]),
			$author$project$Styles$paragraph),
		_List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					...
					$author$project$Styles$buttons.aX),
				{
					_: $mdgriffith$elm_ui$Element$text(t),
					gh: url
				})
			]));
};
var $author$project$Home$View$meetWithExpertTop = $author$project$Home$View$leftCta(
	_Utils_Tuple2('https://calendly.com/anson-flint/intro-to-flint', 'Meet With Us'));
var $author$project$Home$View$orderedList = function (list) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Home$View$cell = $mdgriffith$elm_ui$Element$column(
	_List_fromArray(
		[
			$author$project$Home$View$wf,
			$mdgriffith$elm_ui$Element$alignTop,
...
var $author$project$Home$View$pair = F2(
	function (l1, l2) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$author$project$Home$View$cell(l1),
					$author$project$Home$View$cell(l2)
				]));
	});
var $author$project$Home$View$pw = function (t) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
			[
...
var $author$project$Home$View$desktopView = _List_fromArray(
	[
		A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
											...
											[
												...
												_List_fromArray(
													[
														...
														$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
														$mdgriffith$elm_ui$Element$centerY,
														A2($mdgriffith$elm_ui$Element$paddingXY, 0, 150),
														$mdgriffith$elm_ui$Element$spacing(30),
														$mdgriffith$elm_ui$Element$paddingEach(
														{W: 150, aa: 0, af: 10, ag: 150})
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																$mdgriffith$elm_ui$Element$text('Securing nurses for your future')
															])),
														A2(
														$mdgriffith$elm_ui$Element$paragraph,
														$author$project$Styles$paragraph,
														_List_fromArray(
															[
																$mdgriffith$elm_ui$Element$text('The right nurse. Health care expertise on demand. Find everything you need to optimize your heathcare staffing needs — with Flint.')
															])),
														$author$project$Home$View$meetWithExpertTop
													]))
											])),
										A2(
										$mdgriffith$elm_ui$Element$image,
										_List_fromArray(
											[$author$project$Home$View$wf]),
										{dR: 'Registered Nurses', B: '/static/images/top2.png'})
									])),
								A2(
								$author$project$Home$View$pair,
								_List_fromArray(
									[
										$author$project$Home$View$h2w($author$project$Home$View$copy.bi),
										$author$project$Home$View$orderedList($author$project$Home$View$copy.bj),
										$author$project$Home$View$expand,
										$author$project$Home$View$meetWithExpertTop
									]),
								_List_fromArray(
									[
										$author$project$Home$View$h2w($author$project$Home$View$copy.bA),
										$author$project$Home$View$pw($author$project$Home$View$copy.bB),
										$author$project$Home$View$expand,
										$author$project$Home$View$meetWithExpertTop
									])),
								A2(
								...
								_List_fromArray(
									[
										$author$project$Home$View$h2w($author$project$Home$View$copy.bc),
										$author$project$Home$View$pw($author$project$Home$View$copy.be),
										$author$project$Home$View$pw($author$project$Home$View$copy.bf),
										$author$project$Home$View$orderedList($author$project$Home$View$copy.bd),
										$author$project$Home$View$meetWithExpertTop
									]))
							]))
					]))
...
var $author$project$Home$View$h2 = function (t) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
			[
...
var $author$project$Home$View$cta = function (_v0) {
	var url = _v0.a;
	var t = _v0.b;
	return A2(
		$mdgriffith$elm_ui$Element$column,
...
var $author$project$Home$View$meetWithExpertCta = $author$project$Home$View$cta(
	_Utils_Tuple2('https://calendly.com/anson-flint/intro-to-flint', 'Meet With Us'));
var $author$project$Home$View$p = function (t) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
			[
...
var $author$project$Home$View$phoneView = _List_fromArray(
	[
		A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text($author$project$Home$View$copy.cC)
											]))
									])),
								$author$project$Home$View$meetWithExpertCta,
								$author$project$Home$View$h2($author$project$Home$View$copy.bi),
								$author$project$Home$View$orderedList($author$project$Home$View$copy.bj),
								$author$project$Home$View$h2($author$project$Home$View$copy.bA),
								$author$project$Home$View$p($author$project$Home$View$copy.bB),
								$author$project$Home$View$meetWithExpertCta,
								$author$project$Home$View$h2($author$project$Home$View$copy.bc),
								$author$project$Home$View$p($author$project$Home$View$copy.be),
								$author$project$Home$View$p($author$project$Home$View$copy.bf),
								$author$project$Home$View$orderedList($author$project$Home$View$copy.bd),
								$author$project$Home$View$meetWithExpertCta
							]))
					]))
...
var $author$project$Home$View$view = function (_v0) {
	return {
		bh: _List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Layout$header.bh,
					_Utils_ap($author$project$Home$View$desktopView, $author$project$Layout$footer.bh)))
			]),
		bv: _List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Layout$header.bv,
					_Utils_ap($author$project$Home$View$phoneView, $author$project$Layout$footer.bv)))
			]),
		bE: _List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					$author$project$Layout$header.bE,
					_Utils_ap($author$project$Home$View$desktopView, $author$project$Layout$footer.bE)))
			])
	};
};
var $author$project$Jobs$View$wf = $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill);
var $author$project$Jobs$View$desktopHeader = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$author$project$Jobs$View$wf,
			$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$colors.bP),
			A2($mdgriffith$elm_ui$Element$paddingXY, 100, 0)
		]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[$author$project$Jobs$View$wf, $mdgriffith$elm_ui$Element$alignRight]),
					_List_fromArray(
						[
							A2(
							$mdgriffith$elm_ui$Element$column,
							A2($elm$core$List$cons, $author$project$Jobs$View$wf, $author$project$Styles$paragraph),
							_List_fromArray(
								[
									A2(
									$mdgriffith$elm_ui$Element$row,
...
var $author$project$Jobs$Types$Email = 2;
var $author$project$Jobs$Types$FirstName = 0;
var $author$project$Jobs$Types$LastName = 1;
var $author$project$Jobs$Types$Phone = 3;
var $author$project$Jobs$Types$Reason = 4;
var $author$project$Jobs$Types$Set = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var $author$project$Jobs$Types$Submit = function (a) {
	return {$: 7, a: a};
};
var $author$project$Jobs$Types$UploadResume = {$: 0};
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {W: -box.W, aa: -box.aa, af: -box.af, ag: -box.ag};
};
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{x: _List_Nil, j: _List_Nil, r: _List_Nil, e: _List_Nil, at: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e6)),
...
var $mdgriffith$elm_ui$Element$scrollbarY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.fp);
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			_Utils_eq(textInput.gd, $mdgriffith$elm_ui$Element$Input$TextArea),
		...
		var inputElement = A4(
			...
			_Utils_ap(
				...
				_Utils_ap(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Input$value(textOptions.fV),
							$mdgriffith$elm_ui$Internal$Model$Attr(
							$elm$html$Html$Events$onInput(textOptions.E)),
									...
									function () {
										if (textOptions.fV === '') {
											...
											if (_v1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.fV === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.ey)
															]),
														_List_fromArray(
															[
																$elm$html$Html$text(textOptions.fV + '\u00A0')
															])))
												]);
										}
									}()))
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.x, textOptions.fV === ''))
												]);
										}
									}()
									])))),
...
var $mdgriffith$elm_ui$Element$Input$email = $mdgriffith$elm_ui$Element$Input$textHelper(
	{
		C: $elm$core$Maybe$Just('email'),
		I: false,
		gd: $mdgriffith$elm_ui$Element$Input$TextInputNode('email')
	});
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{C: $elm$core$Maybe$Nothing, I: multi.cz, gd: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{_: multi._, E: multi.E, G: multi.G, fV: multi.fV});
	});
...
var $author$project$Jobs$View$multitextbox = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Border$width(1),
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Border$color($author$project$Styles$colors.bP)
			]))
	]);
var $elm$file$File$name = _File_name;
var $author$project$Jobs$View$smallHeading = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$size(24),
		$author$project$Styles$font
	]);
var $mdgriffith$elm_ui$Element$Input$text = $mdgriffith$elm_ui$Element$Input$textHelper(
	{
		...
		I: false,
		gd: $mdgriffith$elm_ui$Element$Input$TextInputNode('text')
	});
var $author$project$Jobs$View$textbox = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Border$width(1),
		$mdgriffith$elm_ui$Element$padding(7),
		$mdgriffith$elm_ui$Element$focused(
...
var $author$project$Jobs$View$textboxLabel = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$size(15),
		$mdgriffith$elm_ui$Element$alignTop,
		$author$project$Jobs$View$wf
...
var $mdgriffith$elm_ui$Element$Input$username = $mdgriffith$elm_ui$Element$Input$textHelper(
	{
		C: $elm$core$Maybe$Just('username'),
		I: false,
		gd: $mdgriffith$elm_ui$Element$Input$TextInputNode('text')
	});
var $author$project$Jobs$View$desktopApplyView = F2(
	function (job, model) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_Utils_ap(
				_List_fromArray(
					[
						A2(
						$mdgriffith$elm_ui$Element$el,
						$author$project$Jobs$View$smallHeading,
						$mdgriffith$elm_ui$Element$text('Apply')),
						A2(
						$mdgriffith$elm_ui$Element$Input$username,
						$author$project$Jobs$View$textbox,
						{
							_: A2(
								$mdgriffith$elm_ui$Element$Input$labelAbove,
								$author$project$Jobs$View$textboxLabel,
								$mdgriffith$elm_ui$Element$text('First Name')),
							E: $author$project$Jobs$Types$Set(0),
							G: $elm$core$Maybe$Nothing,
							fV: $author$project$Text$toString(model.c3.d8)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$username,
						$author$project$Jobs$View$textbox,
						{
							...
							E: $author$project$Jobs$Types$Set(1),
							G: $elm$core$Maybe$Nothing,
							fV: $author$project$Text$toString(model.c3.eJ)
						}),
						A2(
						...
						$author$project$Jobs$View$textbox,
						{
							...
							E: $author$project$Jobs$Types$Set(2),
							G: $elm$core$Maybe$Nothing,
							fV: $author$project$Text$toString(model.c3.dX)
						}),
						A2(
						...
						$author$project$Jobs$View$textbox,
						{
							...
							E: $author$project$Jobs$Types$Set(3),
							G: $elm$core$Maybe$Nothing,
							fV: $author$project$Text$toString(model.c3.bv)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						A2(
							...
							$author$project$Styles$buttons.aX),
						{
							_: $mdgriffith$elm_ui$Element$text('Upload Resume'),
							cf: $elm$core$Maybe$Just($author$project$Jobs$Types$UploadResume)
						}),
						function () {
						var _v0 = model.c3.fi;
						if (!_v0.$) {
						...
						$author$project$Jobs$View$multitextbox,
						{
							_: A2(
								$mdgriffith$elm_ui$Element$Input$labelAbove,
								$author$project$Jobs$View$textboxLabel,
								$mdgriffith$elm_ui$Element$text(model.dE.dI.gl)),
							E: $author$project$Jobs$Types$Set(4),
							G: $elm$core$Maybe$Nothing,
							cz: true,
							fV: $author$project$Text$toString(model.c3.fc)
						}),
						function () {
						var _v1 = model.d$;
						if (!_v1.$) {
						...
						return _List_fromArray(
							[
								...
								A2(
									...
									$author$project$Styles$buttons.aX),
								{
									_: $mdgriffith$elm_ui$Element$text('Submit'),
									cf: $elm$core$Maybe$Just(
										$author$project$Jobs$Types$Submit(job))
								})
							]);
					}
				}()));
	});
var $author$project$Jobs$View$hiringProcess = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[$author$project$Jobs$View$wf]),
	_List_fromArray(
				...
				[
						...
						[$author$project$Jobs$View$wf]),
					{
						_: A2(
							$mdgriffith$elm_ui$Element$image,
							_List_fromArray(
								[$author$project$Jobs$View$wf, $mdgriffith$elm_ui$Element$centerX]),
							{dR: 'Interview Process', B: '/static/images/hiring-process.svg'}),
						gh: '/static/images/hiring-process.svg'
					})
				]))
		]));
var $author$project$Jobs$View$desktopCopyView = function (config) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(config.dI.dS)
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[$author$project$Jobs$View$wf, $mdgriffith$elm_ui$Element$alignTop]),
							_List_fromArray(
								[
									A2(
									$mdgriffith$elm_ui$Element$paragraph,
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text(config.dI.e4)
										]))
								])),
							A2(
							$mdgriffith$elm_ui$Element$column,
							...
							_List_fromArray(
								[
									...
									A2(
										$elm$core$List$cons,
										$mdgriffith$elm_ui$Element$text(config.dI.e5),
										A2($elm$core$Maybe$withDefault, _List_Nil, config.dI.e$)))
								]))
						]))
				]),
			(config.e1 === 'join') ? _List_fromArray(
				[$author$project$Jobs$View$hiringProcess]) : _List_Nil));
};
var $author$project$Jobs$Types$Apply = F2(
	function (a, b) {
		return {$: 6, a: a, b: b};
	});
var $author$project$Jobs$View$desktopJobView = function (_v0) {
	var page = _v0.a;
	var id = _v0.b;
	var job = _v0.c;
	return A2(
					...
					[
							...
							]),
						{
							_: A2(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(job.bF)
									])),
							gh: A2(
								$elm$url$Url$Builder$absolute,
								_List_fromArray(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(job.eM),
								$mdgriffith$elm_ui$Element$text(job.d_),
								$mdgriffith$elm_ui$Element$text(job.d1)
							]))
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
					...
					[
						...
						A2(
							...
							A2(
								...
								$author$project$Styles$buttons.aX)),
						{
							_: $mdgriffith$elm_ui$Element$text('Apply Now'),
							cf: $elm$core$Maybe$Just(
								A2($author$project$Jobs$Types$Apply, true, id))
						})
					]))
			]));
};
var $author$project$Jobs$View$desktopView = {aF: $author$project$Jobs$View$desktopApplyView, aQ: $author$project$Jobs$View$desktopCopyView, aU: $author$project$Jobs$View$desktopJobView};
...
var $author$project$Jobs$View$jobsView = F2(
	function (viewer, model) {
		jobsView:
		while (true) {
			var _v0 = model.gi;
			if (_v0.$ === 1) {
				return $elm$core$Dict$isEmpty(model.eG) ? A2(
					$mdgriffith$elm_ui$Element$column,
					_List_Nil,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Sorry, no positions are currently open!')
						])) : A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
						...
						[
							...
							A2(
								...
								A2(
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('Open Positions')
										])),
								A2(
									$elm$core$List$map,
									viewer.aU,
									A2(
										...
										function (_v1) {
											var id = _v1.a;
											var job = _v1.b;
											return _Utils_Tuple3(model.dE.e1, id, job);
										},
										$elm$core$Dict$toList(model.eG)))))
						]));
			} else {
				var jobId = _v0.a;
				var _v2 = A2($elm$core$Dict$get, jobId, model.eG);
				if (!_v2.$) {
					var job = _v2.a;
					return A2(
						$mdgriffith$elm_ui$Element$column,
											...
											if (_v3 === '') {
												...
												return A2(
													...
													A2(
														...
														A2(
															$elm$core$Result$mapError,
															$elm$core$Basics$always('error in rendering markdown'),
															$dillonkearns$elm_markdown$Markdown$Parser$parse(desc))));
											}
										}())
									])),
								A2(viewer.aF, job, model)
							]));
				} else {
					var $temp$viewer = viewer,
						$temp$model = _Utils_update(
						model,
						{gi: $author$project$Jobs$Types$JobsView});
					viewer = $temp$viewer;
					model = $temp$model;
					continue jobsView;
				}
...
var $author$project$Jobs$View$phoneHeader = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$author$project$Jobs$View$wf,
...
var $author$project$Jobs$View$phoneApplyView = F2(
	function (job, model) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
...
var $author$project$Jobs$View$phoneCopyView = function (config) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(config.dI.e7)
						])),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
...
var $author$project$Jobs$View$phoneJobView = function (_v0) {
	var page = _v0.a;
	var id = _v0.b;
	var job = _v0.c;
	return A2(
...
var $author$project$Jobs$View$phoneView = {aF: $author$project$Jobs$View$phoneApplyView, aQ: $author$project$Jobs$View$phoneCopyView, aU: $author$project$Jobs$View$phoneJobView};
var $author$project$Jobs$View$workAtDesktop = function (config) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(config.dI.bF)
							]))
					]))
			]));
};
var $author$project$Jobs$View$workAtPhone = function (config) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
...
var $author$project$Jobs$View$view = function (model) {
	return {
		bh: _List_fromArray(
			[
				$author$project$Jobs$View$desktopHeader,
				$author$project$Jobs$View$workAtDesktop(model.dE),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
				...
				A2(
					$elm$core$List$cons,
					A2($author$project$Jobs$View$jobsView, $author$project$Jobs$View$desktopView, model),
					$author$project$Layout$footer.bh))
			]),
		bv: _List_fromArray(
			[
				$author$project$Jobs$View$phoneHeader,
				$author$project$Jobs$View$workAtPhone(model.dE),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
				...
				A2(
					$elm$core$List$cons,
					A2($author$project$Jobs$View$jobsView, $author$project$Jobs$View$phoneView, model),
					$author$project$Layout$footer.bv))
			]),
		bE: _List_fromArray(
			[
	...
	switch (_v0.$) {
		case 0:
			return A2(
				...
				model.dU,
				$author$project$Home$View$view(model.eo));
		case 2:
			return A2(
				$author$project$Layout$layout,
				model.dU,
				$author$project$Contact$View$view(model.dF));
		case 3:
			return A2(
				$mdgriffith$elm_ui$Element$map,
				$author$project$Types$MsgForJobs,
				A2(
					$author$project$Layout$layout,
					model.dU,
					$author$project$Jobs$View$view(model.eG)));
		case 4:
			return A2(
				$mdgriffith$elm_ui$Element$map,
				$author$project$Types$MsgForHealthCare,
				A2(
					$author$project$Layout$layout,
					model.dU,
					$author$project$Jobs$View$view(model.el)));
		case 5:
			return A2(
				$mdgriffith$elm_ui$Element$map,
				$author$project$Types$MsgForBlog,
				A2(
					$author$project$Layout$layout,
					model.dU,
					$author$project$Blog$View$view(model.dk)));
		case 6:
			return A2(
				$mdgriffith$elm_ui$Element$map,
				$author$project$Types$MsgForFaqNurses,
				A2(
					$author$project$Layout$layout,
					model.dU,
					$author$project$FaqNurses$View$view(model.d3)));
		default:
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		ew: $author$project$Update$init,
		eW: A2($elm$core$Basics$composeL, $author$project$Types$MsgForRouter, $author$project$Router$Types$OnUrlChange),
		eX: A2($elm$core$Basics$composeL, $author$project$Types$MsgForRouter, $author$project$Router$Types$OnUrlRequest),
		fL: $author$project$Main$subscriptions,
		gg: $author$project$Update$update,
		gi: $author$project$View$view
	});
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'gitVersion', $elm$json$Json$Decode$string)))(0)}});}(this));