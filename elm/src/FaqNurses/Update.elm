...
faqs =
    ...
    , { question = "**Q: Can my spouse work in the US?**"
      , answer = [ Paragraph "A: Yes, if you have a spouse relocating with you they may be eligible to work in the USA. This is dependent on the type of visa and the terms of your authorization to work in the US. Flints immigration lawyer will advise you on this process." ]
      }
    ...
    , { question = "**Q: Do I start working right after landing in the US?**"
      , answer = [ Paragraph "A: You can expect to begin to work at your healthcare facility within one month depending on the requirements of your employer and the government agencies processing your file. This delay generally gives you time to get settled and organized before you start working." ]
      }
    , { question = "**Q: How much support will I get after landing in the US?**"
      , answer = [ Paragraph "A: To help you transition to your new country we also have a relocation advisor to help advise you on matters such as obtaining a driver's license, bank account etc.. Please see our website for more information on US culture and relocation." ]
      }
