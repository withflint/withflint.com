module Landing.Singapore.View exposing (view)
...
copy =
    ...
    , applyNow = "Apply Now"
    , left = "Flint offers expertise in helping **Singaporean Registered Nurses** obtain a license, a work permit and a profitable job offer directly from the facilities we partner with in the USA. A seamless transition without the hassle."
...
job =
    { url = ""
    , title = "Registered Nurse - Singapore"
    , location = "USA"
    , equity = "0"
    , experience = "5 years+"
